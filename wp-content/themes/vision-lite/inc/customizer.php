...
function vision_lite_sanitize_checkbox( $checked ) {
	...
	$wp_customize->add_control('section_description',array(
			'type'	=> 'text',
			'label'	=> __('Add section description','vision-lite'),
			'section'	=> 'homepage_section'
	));		
...
// Email Address Section
    $wp_customize->add_section('email_section', array(
            'title' => esc_html__( 'Email Address', 'vision-lite' ),
            'priority' => 150
        )
    );      
    ...
    $wp_customize->add_control('email_link', array(
            'label' => esc_html__( 'Add email address', 'vision-lite' ),
	...
	$wp_customize->add_control('email_link',array(
			'type'	=> 'text',
			'label'	=> __('Add email address','vision-lite'),
			'section'	=> 'email_section'
	));  */  
